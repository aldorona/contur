...
2     XMU=CONV*DASIN(ONE/FINAL(3,J))
      ...
      YINCH=SF*FINAL(2,J)
      WRITE (2,103) J,(FINAL(K,J),K=1,3),XMU,PSI,AN,XINCH,YINCH
...
56    IF (MQ.LT.0) GO TO 60
      ...
      YINCH=SF*CHAR(2,K)
      WRITE (2,103) K,(CHAR(J,K),J=1,6),XINCH,YINCH
57    IF (MOD(I,10).EQ.0) WRITE (2,98)
...
66    WTAN(J)=DTAN(WALL(5,J))
      ...
      YINCH=SF*CHAR(2,K)
      WRITE (2,103) K,(CHAR(J,K),J=1,6),XINCH,YINCH
67    IF (MOD(I,10).EQ.0) WRITE (2,98)
68    IF (IQ.LT.0) KO=1
      NAG=KO-1
      KING=LINE+NAG
      DO 69 L=1,LINE
